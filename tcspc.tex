...
\begin{thebibliography}{50}
        \bibitem{Hackbarth} Dr. Steffen Hackbarth: \textsl{Versuchsskript: Zeitkorrelierte Einzelphotonenmessung}
        \bibitem{Röder} Röder et al.: \textsl{Photophysical properties of pheophorbide a in solution and in model membrane systems}
\end{thebibliography}
